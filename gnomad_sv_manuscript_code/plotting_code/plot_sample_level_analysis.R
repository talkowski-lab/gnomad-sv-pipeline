...
# sites.in <- "~/scratch/gnomAD_v2_SV_MASTER.sites.perSample_summary.txt.gz"
# alleles.in <- "~/scratch/gnomAD_v2_SV_MASTER.alleles.perSample_summary.txt.gz"
# functional.in <- "~/scratch/gnomAD_v2_SV_MASTER.functional.perSample_summary.txt.gz"
...
plot.sina.MultiFunc(wdat=all.func.wdat.genes,
                    funcs=c("PROTEIN_CODING__LOF.genes",
                            ...
                            "PROTEIN_CODING__MCNV_LOSS.genes",
                            "PROTEIN_CODING__MCNV_GAIN.genes"),
                    func.labels=c("pLoF","IED","CG","pLoF","CG"),
                    func.cols=c(svtypes$color[which(svtypes$svtype=="DEL")],
                                svtypes$color[which(svtypes$svtype=="MCNV")],
                                svtypes$color[which(svtypes$svtype=="DUP")],
                                svtypes$color[which(svtypes$svtype=="DEL")],
...
points(x=0.5,y=120,xpd=T,pch=23,cex=1,lwd=1.7,bg="white")
dev.off()
#Rare SV
...
plot.sina.MultiFunc(wdat=rare.func.wdat.genes,
                    funcs=c("PROTEIN_CODING__LOF.genes",
                            "PROTEIN_CODING__DUP_LOF.genes",
                            "PROTEIN_CODING__COPY_GAIN.genes"),
                    func.labels=c("pLoF","IED","CG"),
                    func.cols=c(svtypes$color[which(svtypes$svtype=="DEL")],
                                svtypes$color[which(svtypes$svtype=="MCNV")],
                                svtypes$color[which(svtypes$svtype=="DUP")]),
                    pop="ALL",ymax=20,boxes=T)
points(x=0.5,y=18,xpd=T,pch=23,cex=1,lwd=1.7,bg="white")
